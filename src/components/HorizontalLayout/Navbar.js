                        ...
                        <nav className="navbar navbar-light navbar-expand-lg topnav-menu" id="navigation">
                            ...
                            <Collapse isOpen={this.props.menuOpen} className="navbar-collapse" id="topnav-menu-content">
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/account-managment">
                                            <i className="ri-dashboard-line mr-2"></i> {this.props.t('Account Management')}
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/template-management">
                                            <i className="ri-dashboard-line mr-2"></i> {this.props.t('Template Management')}
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/Category_Management">
                                            <i className="ri-dashboard-line mr-2"></i> {this.props.t('Category Management')}
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/Subscription_Management">
                                            <i className="ri-dashboard-line mr-2"></i> {this.props.t('Subscription Management')}
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="nav-link" to="/payment-gateway">
                                            <i className="ri-dashboard-line mr-2"></i> {this.props.t('Payment Gateway Management')}
                                        </Link>
                                    </li>
