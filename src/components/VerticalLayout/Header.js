            ...
            <div className="d-flex ">
              <div className="navbar-brand-box">
                ...
                <Link to="/" className="logo logo-light ">
                  <span className="logo-sm ml-n1">
                    {/* <img src={logo44} alt="" height="30" /> */}
                    <img
                      src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqokEHn4Ei01MHH6LTHqfsbV64jvUCjG5RqQ&s`}
                      alt=""
                      height="30"
                  ...
                  <span className="logo-lg ">
                    {/* <img src={logo44} alt="" height="30" style={{ marginTop: "-0.5rem" }} /> */}
                    <img
                      src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqokEHn4Ei01MHH6LTHqfsbV64jvUCjG5RqQ&s`}
                      alt=""
                      height="30"
                    ...
                    <span className="ml-4" style={{ color: "white", fontSize: "1.5rem" }}>
                      Webapp
                    </span>
                  </span>
                </Link>
