...
import { CategoryBox, CatRow, CatLabel, ButtonBox, CatButton, CatTitle } from "./SubscriptionListElements";
...
export default function Category_Management(props) {
  ...
  const getCategoriesContent = async () => {
    setIsLoading(true);
    try {
      const { data } = await axios.get("/admin/newsletter_user_list");
      console.log(data);
  ...
  const statusSwitch = async (e, id) => {
    try {
      ...
      const { data } = await axios.post("/admin/", { category_id: id, status: e.target.checked });
      // props.history.push({
  ...
  return (
    <React.Fragment>
            ...
            <div className={classes.paperPaddingRightLeft}>
              <div className="py-4">
                <Paper elevation={0} className={classNames(classes.paperHeading, classes.headingAlignment)}>
                  <h3 style={{}}>Subscribed User Listing</h3>
                  <SearchBar
                    // value={searched}
                    className="heightfix"
                    ...
                    <Table className={classes.table} stickyHeader>
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell style={{ fontWeight: "bold", textAlign: "center" }}>Joining Date</TableCell>
                            ...
                            {/* <TableCell className={classes.textMiddle} style={{ textAlign: "center" }}>
                              ...
                              >
                                ...
                                <Tooltip title="Manage Category" arrow>
                                  <WidgetsOutlined style={{ fontSize: "1.3rem" }} />
                                </Tooltip>
                              </Button>
                            </TableCell> */}
                          </TableRow>
      ...
      <Modal
        ...
        content={
          <>
            <Formik enableReinitialize initialValues={catData} validateOnChange onSubmit={handleCat} validate={catValidator}>
              {(formikBag) => {
                return (
                  <Form>
                    <CategoryBox>
                          ...
                          {({ field }) => (
                            <div className="py-2">
                              <Input
                                ...
                                error={formikBag.touched.catName && formikBag.errors.catName ? formikBag.errors.catName : null}
                              />
                            </div>
                          )}
                        </Field>
                          ...
                          {({ field }) => (
                            <div className="py-2">
                              <TextArea
                                ...
                                className="form-control"
                                error={
                                  formikBag.touched.desciption && formikBag.errors.desciption
